...
def validate_sink_and_publication_contracts(text: str) -> None:
    ...
    required_owned_artifacts = {
        ...
        "rust/crates/troupe-diagnostics-runtime/src/store/writer.rs": {"S03", "X02"},
        "rust/src/application/cli.rs": {"D07", "X00", "X01", "X02"},
        "rust/src/diagnostic_runtime/activation.rs": {"X00", "X01", "X02"},
        "rust/src/diagnostic_runtime/bootstrap.rs": {"B00", "X01", "X02"},
        "rust/src/diagnostic_runtime/runtime_producer.rs": {"B01", "X02"},
